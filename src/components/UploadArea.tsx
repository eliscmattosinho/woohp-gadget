    ...
    <div className="flex items-center justify-center w-full animate-in fade-in duration-700">
      ...
      >
        <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
          ...
          <div className="mt-6 px-5 py-2 bg-pink-600/10 rounded-full text-[10px] text-pink-500 font-black uppercase tracking-widest border border-pink-500/20 opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0">
